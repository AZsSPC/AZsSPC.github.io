...
//runOnKeys(function () {console.log('pressed')}, "KeyQ", "ControlLeft");
	on_keys_action(function(){ reformat();}, "AltLeft", "ShiftLeft", "KeyF");
	on_keys_action(function(){ downloadThis();}, "ControlLeft", "KeyD");
...
function downloadThis(){
	...
	if(filename) create_file_and_download(filename, ep.innerText);
}
